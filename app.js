...
bot.on("message", function (event) {
  ...
  async function getWeather(type) {
    ...
    await page.waitForSelector(
      "#forecast_list_ul > table > tbody > tr:nth-child(1) > td:nth-child(2) > b:nth-child(1) > a"
    );
    await page.click(
      "#forecast_list_ul > table > tbody > tr:nth-child(1) > td:nth-child(2) > b:nth-child(1) > a"
    );
    ...
    await page.waitForSelector(
      "#weather-widget > div.section-content > div.grid-container.grid-4-5 > div.current-container.mobile-padding > div:nth-child(1) > span"
    );
    ...
    await page.waitForSelector(
      "#weather-widget > div.section-content > div.grid-container.grid-4-5 > div.current-container.mobile-padding > div:nth-child(1) > h2"
    );
    const location = await page.evaluate(() => {
      return document.querySelector(
        "#weather-widget > div.section-content > div.grid-container.grid-4-5 > div.current-container.mobile-padding > div:nth-child(1) > h2"
    ...
    await page.waitForSelector(
      "#weather-widget > div.section-content > div.grid-container.grid-4-5 > div.current-container.mobile-padding > div:nth-child(2) > div.current-temp > span"
    );
    ...
    await page.waitForSelector(
      "#weather-widget > div.section-content > div.grid-container.grid-4-5 > div.current-container.mobile-padding > div:nth-child(2) > div.bold"
    );
    ...
    await page.waitForSelector(
      "#weather-widget > div.section-content > div.grid-container.grid-4-5 > div.current-container.mobile-padding > div:nth-child(2) > ul > li:nth-child(1) > div"
    );
    ...
    await page.waitForSelector(
      "#weather-widget > div.section-content > div.grid-container.grid-4-5 > div.current-container.mobile-padding > div:nth-child(2) > ul > li:nth-child(2)"
    );
    ...
    await page.waitForSelector(
      "#weather-widget > div.section-content > div.grid-container.grid-4-5 > div.current-container.mobile-padding > div:nth-child(2) > ul > li:nth-child(3)"
    );
    ...
    await page.waitForSelector(
      "#weather-widget > div.section-content > div.grid-container.grid-4-5 > div.current-container.mobile-padding > div:nth-child(2) > ul > li:nth-child(4)"
    );
    ...
    await page.waitForSelector(
      "#weather-widget > div.section-content > div.grid-container.grid-4-5 > div.current-container.mobile-padding > div:nth-child(2) > ul > li:nth-child(5)"
    );
  ...
  async function luck(star, url) {
    ...
    const page = await browser.newPage();
    await page.goto("https://astro.click108.com.tw/daily_10.php?iAstro=" + url);
    await page.waitForSelector(
  ...
  async function translate(str) {
    ...
    event.reply("翻譯結果為:" + textResult);
  }
  async function wiki(str) {
    let browser;
  ...
  async function bill(
    ...
    //特別獎
    await page.waitForSelector(
      "#etw-container > div > div.container-fluid.etw-bgbox.mb-4 > div.etw-mobile > table > tbody > tr:nth-child(1) > td:nth-child(2) > p.etw-tbiggest > span"
    );
    //特獎
    await page.waitForSelector(
      "#etw-container > div > div.container-fluid.etw-bgbox.mb-4 > div.etw-mobile > table > tbody > tr:nth-child(2) > td:nth-child(2) > p.etw-tbiggest > span"
    );
    //頭獎
    await page.waitForSelector(
      "#etw-container > div > div.container-fluid.etw-bgbox.mb-4 > div.etw-mobile > table > tbody > tr:nth-child(3) > td:nth-child(2) > p:nth-child(1) > span:nth-child(1)"
    );
    await page.waitForSelector(
      "#etw-container > div > div.container-fluid.etw-bgbox.mb-4 > div.etw-mobile > table > tbody > tr:nth-child(3) > td:nth-child(2) > p:nth-child(2) > span:nth-child(1)"
    );
    await page.waitForSelector(
      "#etw-container > div > div.container-fluid.etw-bgbox.mb-4 > div.etw-mobile > table > tbody > tr:nth-child(3) > td:nth-child(2) > p:nth-child(3) > span:nth-child(1)"
    );
    await page.waitForSelector(
      "#etw-container > div > div.container-fluid.etw-bgbox.mb-4 > div.etw-mobile > table > tbody > tr:nth-child(3) > td:nth-child(2) > p:nth-child(1) > span.font-weight-bold.etw-color-red"
    );
    await page.waitForSelector(
      "#etw-container > div > div.container-fluid.etw-bgbox.mb-4 > div.etw-mobile > table > tbody > tr:nth-child(3) > td:nth-child(2) > p:nth-child(2) > span.font-weight-bold.etw-color-red"
    );
    await page.waitForSelector(
      "#etw-container > div > div.container-fluid.etw-bgbox.mb-4 > div.etw-mobile > table > tbody > tr:nth-child(3) > td:nth-child(2) > p:nth-child(3) > span.font-weight-bold.etw-color-red"
    );
    ...
    if (text.trim() == special_award.trim()) {
      ...
      text.trim() == head_award_1 ||
      text.trim() == head_award_2 ||
      text.trim() == head_award_3
    ) {
      event.reply("恭喜你的發票中頭獎!!!(❁´◡`❁)");
    } else if (
      second_text.trim() == second_award_1 ||
      second_text.trim() == second_award_2 ||
      second_text.trim() == second_award_3
    ) {
      event.reply("恭喜你的發票中二獎!!!☜(ﾟヮﾟ☜)");
    } else if (
      third_text.trim() == third_award_1 ||
      third_text.trim() == third_award_2 ||
      third_text.trim() == third_award_3
    ) {
      event.reply("恭喜你的發票中三獎!!!(☞ﾟヮﾟ)☞");
    } else if (
      fourth_text.trim() == fourth_award_1 ||
      fourth_text.trim() == fourth_award_2 ||
      fourth_text.trim() == fourth_award_3
    ) {
      event.reply("恭喜你的發票中四獎!!!φ(゜▽゜*)♪");
    } else if (
      fifth_text.trim() == fifth_award_1 ||
      fifth_text.trim() == fifth_award_2 ||
      fifth_text.trim() == fifth_award_3
    ) {
      event.reply("恭喜你的發票中五獎!!![]~(￣▽￣)~*");
    } else if (
      sixth_text.trim() == head_award_1_red ||
      sixth_text.trim() == head_award_2_red ||
      sixth_text.trim() == head_award_3_red
    ) {
  ...
  async function kkbox() {
    ...
    await page.goto(
      "https://kma.kkbox.com/charts/weekly/song?terr=tw&lang=tc&cate=308%27"
    );
  ...
  let prewiki = prefix + wiki;
  if (event.message.text.includes(prewiki)) {
    let srch = event.message.text.replace(prewiki, "").trim();
    wiki(srch);
  }
});
