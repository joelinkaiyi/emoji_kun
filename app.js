...
function drama(){
  (async () => {
    ...
    const page = await browser.newPage();
    await page.goto('https://www.kktv.me/');
    await page.waitForSelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(1) > div > div.cover-view__desc > div.desc-title')
    await page.waitForSelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(2) > div > div.cover-view__desc > div.desc-title')
    await page.waitForSelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(3) > div > div.cover-view__desc > div.desc-title')
    await page.waitForSelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(4) > div > div.cover-view__desc > div.desc-title')
    await page.waitForSelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(5) > div > div.cover-view__desc > div.desc-title')
    await page.waitForSelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(6) > div > div.cover-view__desc > div.desc-title')
    await page.waitForSelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(7) > div > div.cover-view__desc > div.desc-title')
    await page.waitForSelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(8) > div > div.cover-view__desc > div.desc-title')
    await page.waitForSelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(9) > div > div.cover-view__desc > div.desc-title')
    await page.waitForSelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(10) > div > div.cover-view__desc > div.desc-title')
    const drama_1=await page.evaluate(()=>{
      return document.querySelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(1) > div > div.cover-view__desc > div.desc-title').textContent
    })
    const drama_2=await page.evaluate(()=>{
      return document.querySelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(2) > div > div.cover-view__desc > div.desc-title').textContent
    })
    const drama_3=await page.evaluate(()=>{
      return document.querySelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(3) > div > div.cover-view__desc > div.desc-title').textContent
    })
    const drama_4=await page.evaluate(()=>{
      return document.querySelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(4) > div > div.cover-view__desc > div.desc-title').textContent
    })
    const drama_5=await page.evaluate(()=>{
      return document.querySelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(5) > div > div.cover-view__desc > div.desc-title').textContent
    })
    const drama_6=await page.evaluate(()=>{
      return document.querySelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(6) > div > div.cover-view__desc > div.desc-title').textContent
    })
    const drama_7=await page.evaluate(()=>{
      return document.querySelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(7) > div > div.cover-view__desc > div.desc-title').textContent
    })
    const drama_8=await page.evaluate(()=>{
      return document.querySelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(8) > div > div.cover-view__desc > div.desc-title').textContent
    })
    const drama_9=await page.evaluate(()=>{
      return document.querySelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(9) > div > div.cover-view__desc > div.desc-title').textContent
    })
    const drama_10=await page.evaluate(()=>{
      return document.querySelector('#__next > div.layout > main > div.sc-791d0ddd-1.dlSIvo.highlight-list > div.lovo-list.highlight-list__list > div.sc-d9658a43-0.iwQZGx.block-list > div.block-list__main-container > div:nth-child(10) > div > div.cover-view__desc > div.desc-title').textContent
    })
