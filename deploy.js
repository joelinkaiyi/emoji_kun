...
function handleEvent(event) {
  ...
  const google_news = async () => {
    try {
      const url = "https://news.google.com.tw/";
      ...
      $("a.WlydOe").each((i, el) => {
        const title = $(el).text();
        const url = `https://news.google.com.tw${$(el).attr("href")}`;
        ...
        contents: {
          ...
          contents: articles.map((article) => {
            return {
              ...
              hero: {
                type: "image",
                url: "https://i.imgur.com/eS5tr5R.png",
                size: "full",
                aspectMode: "cover",
                aspectRatio: "20:13",
              },
